...
#ifndef ALICEO2_MFT_MISALIGNMENTPARAMETER_H_
#define ALICEO2_MFT_MISALIGNMENTPARAMETER_H_
...
class MisalignmentParameter : public FairParGenericSet
{
 public:
  MisalignmentParameter(const char* name = "MisalignmentParameter",
                        const char* title = "Misalignment parameter for AliceO2MFTHitProducerIdealMisallign Parameters",
